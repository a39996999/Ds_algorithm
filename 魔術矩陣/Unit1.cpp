...
void show2(){
	AnsiString s ,space = "" ;
	int k = 0 ;
	Form1 -> Memo2 -> Lines -> Add("--------------生成一個"+IntToStr(n)+"*"+IntToStr(n)+"的魔術矩陣-------------\r\n") ;
	for ( int i = 1; i <= n; i++) {
		for (int j = 1; j <= n; j++) {
			k = 0;
			space = "" ;
...
void show3(){
	AnsiString s ,space = "" ;
	int k = 0 ;
	Form1 -> Memo5 -> Lines -> Add("--------------生成一個"+IntToStr(n)+"*"+IntToStr(n)+"的魔術矩陣-------------\r\n") ;
	for ( int i = 1; i <= n; i++) {
		for (int j = 1; j <= n; j++) {
			k = 0;
			space = "" ;
...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
    ...
    if ( n%2 == 0 ) {
		Memo2 -> Lines -> Add("--------------請輸入奇數!--------------\r\n") ;
		Memo5 -> Lines -> Add("--------------請輸入奇數!--------------\r\n") ;
	}
}
//---------------------------------------------------------------------------
...
void __fastcall TForm1::Button2Click(TObject *Sender)
{
	...
	if ( n%2 == 0 ) {
		Memo1 -> Lines -> Add("--------------請輸入奇數!--------------\r\n") ;
		Memo3 -> Lines -> Add("--------------請輸入奇數!--------------\r\n") ;
		Memo4 -> Lines -> Add("--------------請輸入奇數!--------------\r\n") ;
	}
	else{
		re() ;
		switch(flag){
			...
			case 4 : generate_rB() ;
					 ...
					 break ;
			default :
				Memo1 -> Lines -> Add("--------------請選擇方向!--------------\r\n") ;
				Memo3 -> Lines -> Add("--------------請選擇方向!--------------\r\n") ;
				Memo4 -> Lines -> Add("--------------請選擇方向!--------------\r\n") ;
				break ;
		}
	}
}
